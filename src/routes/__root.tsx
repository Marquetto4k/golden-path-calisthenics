...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Protocolo Calistenia Asiática" },
      { name: "description", content: "Força natural e vitalidade para homens 40+." },
      { name: "author", content: "Protocolo Calistenia Asiática" },
      { property: "og:title", content: "Protocolo Calistenia Asiática" },
      { property: "og:description", content: "Desafio de 28 dias para homens 40+." },
